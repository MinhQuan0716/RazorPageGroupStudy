...
namespace Infracstuructures.Migrations
{
    ...
    [Migration("20230618011344_fix-comment-column")]
    partial class fixcommentcolumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasIndex("ReplyToCommentId")
                        .IsUnique()
                        .HasFilter("[ReplyToCommentId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Comment", "ReplyComment")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Comment", "ReplyToCommentId")
